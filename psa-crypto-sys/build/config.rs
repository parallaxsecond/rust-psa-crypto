...
/* this file generated by psa-crypto-sys/build/config.rs */
...
DEFAULT_DEFINES was generated using the script at ../../extract-defines.py,
like:
   python3 ./extract-defines.py >defines.txt
...
pub const FEATURE_DEFINES: &'static [(&'static str, CDefine)] = &[
    ...
    ("zlib",                  ("MBEDTLS_ZLIB_SUPPORT",                      Undefined)),
